...
export default function Home() {
  return (
    <main className="min-h-screen px-3 md:px-7 py-3">
      <nav className="py-3 grid grid-cols-8 gap-3 text-sm">
        ...
        <div className="col-span-7 gap-3 flex flex-row items-center justify-start">
          ...
          <button
            style={{ backgroundColor: "#27357A" }}
            className="flex flex-row gap-2 items-center text-xs rounded-full py-3 px-5 text-white"
          >
            <CarIcon />
            My Garage
          </button>
          <div className="flex flex-row gap-4 items-center ml-auto mr-0 pl-4">
            ...
            <button className="px-1 relative">
              <span
                className="absolute top-0 right-0 bg-yellow-400 rounded-full w-3 h-3 flex items-center justify-center"
